...
const LoansController = require('../../controllers/api/loans.js');

exports.register = function (server, options, next) {
  // Setup the controller
  const loansController = new LoansController(options.database);
      ...
      config: {
        ...
        validate: {
          payload: {
            ...
            socialSecurity: Joi.string().regex(
                /^[0-9]{3}\-?[0-9]{2}\-?[0-9]{4}$/).required()
          }
        }
      }
    }
